...
class Portofolio extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model("portofolio_models");
		$this->load->library('form_validation');
	}

	public function index()
	{
		$data['portofolio'] = $this->portofolio_models->getPortofolio();
		var_dump($data);
	...
	public function add()
	{
		$portofolio = $this->portofolio_models;
	...
	public function edit($id = null)
	{
		...
		if ($validation->run()) {
			$portofolio->update();
			$this->session->set_flashdata('succes', 'Data portofolio Berhasil dirubah');
			redirect(site_url('admin/portofolio'));
	...
	public function delete($id=null)
	{
		...
		if ($this->portofolio_models->delete($id)) {
			redirect(site_url('admin/portofolio'));
		}
	}
}
