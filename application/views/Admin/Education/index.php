            ...
            <div class="modal-body">
              ...
              <div class="row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="nama_pend" class="form-control" placeholder="Nama Pendidikan . ." value="">
                  </div>
                </div>
              </div>
              <div class="row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="ket_pend" class="form-control" placeholder="Nama Pendidikan . ." value="">
                  </div>
                </div>
              </div>
            </div>
