            ...
            <div class="card card-primary">
              ...
              <form role="form" action="<?php base_url('admin/user/edit') ?>" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $user['uname'] ?>" class="form-control <?php echo form_error('uname') ? 'is-invalid':'' ?>" id="uname" placeholder="Uname" name="uname">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $user['pass'] ?>" class="form-control <?php echo form_error('pass') ? 'is-invalid':'' ?>" id="pass" placeholder="Pass" name="pass">
                    <div class="invalid-feedback">
